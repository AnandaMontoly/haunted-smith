...
class doNPC(NPC):
   """a fetch npc that won't take your stuff"""
...
""")
   ...
   #ITEMS
   cutePoem = Item("A cute poem","A poem about art, love, and flowers Allison wrote on the card that you made",True)
   ...
   card = Item("A handmade card","Allison asked you to make this",True)
   #COMBO CREATIONS
   ...
   gillett = eventRoom("gillett","Gillett House","Somehow, the best house on campus",[[toElmStreet,True]],["This place is pretty great",
